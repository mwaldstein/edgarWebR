...
filing_filers <- function(href) {
  ...
  info_pieces <- list(
    ...
    "company_name" = "substring-before(div[@class='companyInfo']/span[@class='companyName']/text()[1], ' (Filer)')",
    "company_cik" = "substring-before(div[@class='companyInfo']/span[@class='companyName']/a,' (')",
    "company_filings_href" = "div[@class='companyInfo']/span[@class='companyName']/a/@href",
    "company_irs_number" = "div/p[@class='identInfo']/strong[1]",
    "company_incorporation_state" = 
      "div/p[@class='identInfo']/text()[contains(.,'Incorp')]/following-sibling::strong[1]",
    "company_fiscal_year_end" = 
      "div/p[@class='identInfo']/text()[contains(.,'Year End')]/following-sibling::strong[1]",
    "filing_type" = 
      "div/p[@class='identInfo']/text()[contains(.,'Type:')]/following-sibling::strong[1]",
    "filing_act" = 
      "div/p[@class='identInfo']/text()[contains(.,'Act:')]/following-sibling::strong[1]",
    "filing_number_href" = "div/p[@class='identInfo']/a[1]/@href",
    "filing_number" = "div/p[@class='identInfo']/a[1]",
    "film_number" = 
      "div/p[@class='identInfo']/text()[contains(.,'Film No.:')]/following-sibling::strong[1]",
