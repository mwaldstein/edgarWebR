 ...
 * A bug was encountered on the Solaris CRAN checks which led to the package
   being removed from CRAN. I'm working on a fix, but not having access to the
   platform makes testing challenging.
